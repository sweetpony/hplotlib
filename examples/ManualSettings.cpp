...
int main()
{
    ...
    cs.setAxisProperties(hpl::Flags<hpl::AxisFlags>(hpl::PaintPrimary, hpl::PaintSecondary, hpl::PaintMinorTicks, hpl::PaintLabelsPrimary, hpl::PaintLabelsSecondary));
    cs.getXAxis().setTickMode(hpl::TickMode::Fixed);
